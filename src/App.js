...
function App() {
  ...
  const menuRef = useRef(null); // <=== ref untuk seluruh area menu (gambar + isi)
    ...
    <div className={`App ${darkMode ? "dark-mode" : ""}`}>
      ...
      <div ref={menuRef} className="menu-container">
        ...
        {menuOpen && (
          <div className="sidebar" ref={sidebarRef}>
            ...
            <a href="#projects4" onClick={() => setMenuOpen(false)}>
        ...
        <div className="jkt48-container">
          ...
          <div className="jkt48-text">
            <p>
              ...
              mengubah segalanya. Dari sebuah pertemuan sederhana, mereka mulai
              saling mengenal, saling memahami, dan menemukan arti baru dari
              kehadiran seseorang dalam hidup.
            </p>
            <p>
              ...
              dalam—sebuah kebutuhan untuk saling ada di setiap langkah. Melalui
              kisah ini, saya ingin menyampaikan pesan bahwa di balik setiap
              jendela yang tertutup, selalu ada cahaya yang menunggu untuk
              ditemukan; kita hanya perlu keberanian untuk membukanya.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="projects2" className="projects2">
        ...
        <div className="jkt48-container">
          ...
          <div className="jkt48-text">
            <p>
              Ini adalah novel favorit saya yang berjudul “The Secret Relationship.”
              Ceritanya berpusat pada dua murid SMA, Lea dan Leo, yang tiba-tiba
              harus menikah muda tanpa cinta dan tanpa persiapan apa pun. Mereka
              bahkan tidak pernah berbicara sebelumnya, namun takdir mempertemukan
              mereka dalam situasi yang tak terduga—sebuah pernikahan sederhana di
              ruangan rumah sakit, hanya dengan seragam sekolah yang mereka kenakan.
            </p>
            <p>
              Kisah ini menggabungkan romansa rahasia, konflik batin, dan sentuhan
              komedi ringan yang membuat hubungan mereka semakin menarik. Di sekolah,
              mereka berpura-pura tidak saling mengenal, sementara di luar kelas
              mereka belajar memahami arti dari sebuah ikatan yang tak mereka pilih.
              The Secret Relationship mengajarkan bahwa cinta bisa tumbuh dari keadaan
      ...
      <section id="projects3" className="projects3">
        ...
        <div className="jkt48-container">
          ...
          <div className="jkt48-text">
            ...
            <p>
              Dari berbagai member yang berbakat, oshi saya adalah{" "}
              <strong>Reva Fidela Adel Pantjoro.</strong> Melihat perjuangannya
              membuat saya semakin semangat untuk terus berusaha dalam hal yang
              saya sukai.
            </p>
            <button
              onClick={() => {
      ...
      <section id="kontak" className="contact">
        ...
        <p>
          Instagram:{" "}
          <a href="https://www.instagram.com/abiyyzz__">@abiyyzz__</a>
        </p>
        <p>
          Whatsapp: <a href="https://wasap.at/etgNVI">+62 857-4669-6663</a>
        </p>
      </section>
